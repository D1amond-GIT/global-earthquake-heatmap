...
1. Imported global earthquake coordinate dataset
2. Cleaned and formatted spatial data
3. Generated heatmap using QGIS density analysis
4. Styled map layers and produced final layout
...
The QGIS project file is included for reference.  
The original datasets are not included due to size and licensing constraints.

Layer paths in the project file reference local directories.  
Data sources are documented in `data_sources.md`.

## Data Sources

See `data_sources.md` for dataset links.
